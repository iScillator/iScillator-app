...
const config_app_vl = {
  "title": "Исцеллятор Авадхутовского",
  "description": "iScillator Avadhutovsky",
  ...
  "gradient2": LinearGradient(begin: Alignment.topRight, end: Alignment.bottomRight, colors: [
    Color.fromARGB(255, 209, 253, 255),
    Color.fromARGB(255, 253, 219, 146),
  ]),
...
const config_app_pro = {
  ...
  "gradient2": LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [
    Color.fromRGBO(7, 117, 229, 1.0),
    Color.fromRGBO(12, 232, 92, 1.0),
  ])
};
...
const Map<String, dynamic> configs = {
  ...
  "android/com.iscillator": config_app_vl,
